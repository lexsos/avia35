...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'documents_document', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.DocumentCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.category'
        db.delete_column(u'documents_document', 'category_id')
